    ...
    public partial class frmProveedor : Form
    {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            if (obj.idProveedor == 0)
            {
                ...
                {
                    dgvData.Rows.Add(new object[] {
                        "", idGenerado, obj.Documento, obj.RazonSocial, obj.Correo, obj.Telefono,
            ...
            {
                bool resultado = new CN_Proveedor().Editar(obj, out string mensaje);
        ...
        private void btnelimiar_Click(object sender, EventArgs e)
        {
            if (txtid.Text != "0")
            {
                if (MessageBox.Show("¿Desea eliminar este Proveedor?", "Mensaje", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    bool respuesta = new CN_Proveedor().Eliminar(obj, out string mensaje);
            ...
            {
                MessageBox.Show("Seleccione un Proveedor para eliminar.", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
